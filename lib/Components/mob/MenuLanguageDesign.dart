...
class MenuLanguageDesign extends StatelessWidget {
  ...
  const MenuLanguageDesign({required this.title, required this.subTitle,required this.text1,required this.text2,required this.text3,required this.text4,required this.widget,required this.widget2,required this.widget3,required this.widget4,});
