                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                                        ...
                                        itemBuilder: (context, indexChoice) {
                                          ...
                                          return Padding(
                                            ...
                                            child: MaterialButton(
                                              ...
                                              child: Text(
                                                  get.categoricalQuestions[indexQ].choices?[indexChoice] ?? '',
                                                  style: TextStyle(
                                                      color: Colors.white,
                                                      fontSize:
                                                          size.height * 0.025)),
                              ...
                              Text(widget.demographicAnswer.isNotEmpty
                                  ? widget.demographicAnswer.toString()
                                  : ""),
                  ...
                  onPressed: () {
                    setState(() {
                      if (indexQ > 0) {
                        ...
                        } else if (get.categoricalQuestions[indexQ].type ==
                            "choice") {
