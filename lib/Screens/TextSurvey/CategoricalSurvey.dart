...
class _CategoricalPageState extends State<CategoricalPage> {
  ...
  void getTypes() {
    ...
    for (int i = 0; i < count2; i++) {
      ...
      if(get.categoricalQuestions[i].type=="choice"){
        text.add([]);
      }else{
        text.add(0);
      }
                                              ...
                                              return Padding(
                                                ...
                                                child: MaterialButton(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(get.categoricalQuestions[indexQ].choices?[indexChoice] ?? '',style:TextStyle(color: Colors.white,fontSize: size.width*0.05)),
                                                  ),
                                                ),
                                              );
                                            },
