...
class OpenEndedSpeechSurveyTab extends StatefulWidget {
  ...
  const OpenEndedSpeechSurveyTab({super.key, required this.widget, required this.widget2, required this.demographicType,required this.demographicAudio, required this.categoricalAudio, required this.categoricalType});
