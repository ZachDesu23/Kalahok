...
import 'package:kalahok/Screens/SpeechSurvey/OpenEndedSpeechSurvey.dart';
...
class CategoricalSpeechSurvey extends StatefulWidget {
...
class _CategoricalSpeechSurveyState extends State<CategoricalSpeechSurvey> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Categorical Question',style: TextStyle(fontSize: 25,color: Colors.white)),
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('Question ${indexQ+1}/${snapshot.data?.categoricalQuestions.length}',style: textTitle(size.width*0.067, Color(0xFF334089)),),
                          ),
                          LinearProgressIndicator(
                            value: indexQ/get.categoricalQuestions.length,
